...
const RevealText = () => {
  ...
  return (
    <section ref={containerRef} className="h-[500vh] mb-10 relative">
      <div className="h-screen bg-background flex sticky top-0 z-10 w-full items-center justify-center overflow-hidden">
        {/* MAIN */}
        <motion.h1
          style={{
            y: sahilY,
          ...
          className={cn(textStyles.h1, " text-white ")}
        >
        ...
        {words.map((item, index) => {
          ...
          return (
            <motion.h1
              ...
              className={cn(
                textStyles.h1,
                "absolute text-white/60 whitespace-nowrap z-40 ",
                item.scale,
                item.pos,
              )}
            >
